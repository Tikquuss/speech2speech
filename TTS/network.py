...
from .config import num_mels, outputs_per_step, embedding_size, hidden_size, hidden_size, n_mels, n_fft 
...
class MelDecoder(nn.Module):
    ...
    def __init__(self, num_hidden):
        ...
        self.pos_dropout = nn.Dropout(p=0.1)
        self.alpha = nn.Parameter(t.ones(1))
        self.decoder_prenet = Prenet(num_mels, num_hidden * 2, num_hidden, p=0.2)
